                        ...
                        empleados.map((empleado, indice) => (
                            ...
                            <td className="text-center">
                                <div>
                                    ...
                                    <Link to={`/editar/${empleado.idEmpleado}`} className="btn btn-danger btn-sm me-3">
                                    ...
                                    <Link to={`/editar/${empleado.idEmpleado}`} className="btn btn-danger btn-sm me-3">Eliminar</Link> */}
                                </div>
                            </td>
                            </tr>
                        ))
